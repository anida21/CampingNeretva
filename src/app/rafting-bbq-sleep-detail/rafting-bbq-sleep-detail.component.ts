...
@Component({
  selector: 'app-rafting-bbq-sleep-detail',
  templateUrl: './rafting-bbq-sleep-detail.component.html',
  styleUrls: ['./rafting-bbq-sleep-detail.component.css']
})
export class RaftingBbqSleepDetailComponent implements OnInit {
  emailForm: EmailForm = {
